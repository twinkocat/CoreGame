...
namespace twinkocat.Storages
{
    ...
    public static class StorageGetter
    {
        ...
        {
            return ApplicationStorage.Instance.MusicStorage.musicData.TryGetValue(music, out clip);
        }

        public static bool TryGetSceneGroupFromStorage(SceneGroup group, out List<SceneData> sceneData)
        {
            return ApplicationStorage.Instance.SceneGroupStorage.sceneGroups.TryGetValue(group, out sceneData);
        }

        public static UIStorage GetUIStorage()
        {
            return ApplicationStorage.Instance.UIStorage;
        }
    }
}