...
namespace twinkocat.Core.Pool
{
    public class ComponentPoolBehaviour : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _objectPool = new ObjectPool<Component>(prefab, isExpandable, isActiveByDefault, objectCount, activeHolder,
                poolHolder);
        }
        ...
        public void DestroyComponentPool()
        {
            _objectPool.DestroyPool();
        }
    }
}